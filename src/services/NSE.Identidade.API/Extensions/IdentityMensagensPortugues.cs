...
{
    /// <summary>
    /// Essa classe faz um override em todos tipos de erro de ENG para PT
    /// *** Tem q colocar essa referencia no arquivo Setup.cs na parte 'AddDefaultIdentity' como 'AddErrorDescriber'
    /// </summary>
