...
{
    /// <summary>
    /// Essa classe tem função de recriar a abstração do EasyNetQ porém com essa nova abstração fica mais fácil
    /// para tratamentos melhores e reaproveitamento para outros tipos de gerenciadores de filas
    /// </summary>
    public class MessageBus : IMessageBus
    {
        ...
        private void TryConnect()
        {
            ...
            // policy criada para reTentativas de conexões em caso de falha
